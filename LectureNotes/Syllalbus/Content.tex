...
% \begin{center}
% {\small
% \input{schedulecontent.tex}}
% \end{center}
%% \end{frame}

\begin{center}
\resizebox{6.5in}{!}{\begin{tikzpicture}[xscale=.9]
% Row 1
...
%\draw[-{Computer Modern Rightarrow[length=20mm,width=30mm]}
%\draw[-{Computer Modern Rightarrow[length=20mm,width=30mm]},line width=30pt,color=red!20!white] (0,-2) -- (15,-2) ..  controls ++(1,0) and ++(1,0) ..  (16,-6.5) --  (0,-6.5); 
%\draw[-{Computer Modern Rightarrow[length=20mm,width=30mm]},line width=30pt,color=green!20!white] (0,-4) -- (2,-4) .. controls ++(1,0) and ++(-1,0) .. (4,-2.25) -- (6,-2.25) .. controls ++(1,0) and ++(-1,0) .. (8,-4) -- (10,-4) .. controls ++(1,0) and ++(-1,0) .. (12,-2.25) -- (15,-2.25) .. controls ++(1,0) and ++(1,0) .. (16,-6.75) .. controls ++(-1,0) and ++(1,0) .. (14,-8.5) -- (12,-8.5) .. controls ++(-1,0) and ++(1,0) .. (10,-6.75) -- (8,-6.75) .. controls ++(-1,0) and ++(1,0) .. (6,-8.5) -- (4,-8.5) .. controls ++(-1,0) and ++(1,0) .. (2,-6.75) -- (0,-6.75); 
